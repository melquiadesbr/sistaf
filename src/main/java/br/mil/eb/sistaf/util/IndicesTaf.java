...
public class IndicesTaf {
	...
	public static Map<String,int[]> getIndices() {
		...
		mapaIndices.put("B40M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B41M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B42M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B43M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B44M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B45M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B46M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B47M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B48M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B49M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B50M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B51M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B51M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B52M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B53M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B54M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B55M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B56M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B57M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B58M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B59M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B61M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B61M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B62M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B63M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B64M", configuraArray(-1,-1,-1,-1,-1));
		mapaIndices.put("B65M", configuraArray(-1,-1,-1,-1,-1));
